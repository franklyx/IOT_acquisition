        ...
        <div>
            ...
            <div class="list-title">
                <el-row class="list-row">
                  <el-col :xs="24" :sm="12" :md="12" :lg="5" v-if="filteredHasBeen[0]"><span>产品型号：{{filteredHasBeen[0]['ProductModel']}}</span></el-col>
                  <el-col :xs="24" :sm="12" :md="12" :lg="3" v-if="filteredHasBeen[0]"><span>出厂编号：{{filteredHasBeen[0]['ManufacturingCode']}}</span></el-col>
                  <el-col :xs="24" :sm="12" :md="12" :lg="3" v-if="filteredHasBeen[0]"><span>出厂日期：{{filteredHasBeen[0]['ManufacturingDate']}}</span></el-col>
                </el-row>
            </div>
