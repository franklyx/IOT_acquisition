<template>
    <div>
        <el-form :inline="true" class="demo-form-inline" :model="ruleForm" @submit.native.prevent v-if="isFormStatus" ref="ruleForm">
            <el-form-item label="车间名称" prop="workShopName">
                <el-input v-model="ruleForm.workShopName" placeholder="车间名称" @keydown.enter.native="addWorkShopFn"></el-input>
            </el-form-item>
            <el-form-item>
...
export default {
    ...
    methods: {
        ...
        addWorkShopFn() {
            addWorkShop({
                id: this.getFactoryId,
                name: this.ruleForm.workShopName
            }).then(res => {
                if (res.code === 201) {
                    this.$message({
                        type: 'success',
