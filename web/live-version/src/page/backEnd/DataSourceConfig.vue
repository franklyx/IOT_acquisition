        ...
        <el-table :data="tableData" style="width: 100%" stripe>
            ...
            <el-table-column prop="status" align="center" min-width="180" label="运行状态">
                <template scope="scope">
                    <el-switch v-model="scope.row.status" on-text="on" off-text="off" on-value="active" off-value="stopped" @change="modifyStatus(scope.$index,scope.row)"></el-switch>
                </template>
            </el-table-column>
...
<style scoped>
.data-source .demo-table-expand {
    font-size: 0;
}

.data-source .demo-table-expand label {
    width: 90px;
    color: #99a9bf;
}

.data-source .demo-table-expand .el-form-item {
    margin-right: 0;
    margin-bottom: 0;
    width: 50%;
}
