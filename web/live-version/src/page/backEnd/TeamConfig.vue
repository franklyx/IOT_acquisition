<template>
    <div>
        <el-form :model="formInline" ref="formInline" :inline='true' label-width="80px" @submit.native.prevent class="from-box">
            ...
            <el-form-item label="选择设备" prop="equipment_list">
                <el-checkbox-group v-model="formInline.equipment_list">
    ...
    methods: {
        ...
        addWorkGroupFN() {
            addWorkGroup({
                ...
                equipment_list: this.formInline.equipment_list
            }).then(res => {
                if (res.code === 201) {
                    this.$message({
                        type: 'success',
