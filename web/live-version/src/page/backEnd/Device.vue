<template>
    <div>
        <el-form :inline="true" :model="formInline" ref="formInline" class="demo-form-inline" @submit.native.prevent v-if="isFormStatus">
            ...
            <el-form-item label="生产线名称" prop="selectProLine">
