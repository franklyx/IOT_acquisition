...
<template>
    <div class="header">
        ...
        <router-link to="/index/0-1" class="title" tag="h2">焊机设备信息化管理平台</router-link>
        <div class="fr">
            <div class="dropdown">
                <el-dropdown trigger="click">
                   ...
                   {{getUserName}}<i class="el-icon-caret-bottom el-icon--right"></i>
                    ...
                    <el-dropdown-menu slot="dropdown">
                        ...
                        <el-dropdown-item>
                            <router-link to="/supervise/user" tag="p" v-if="getRole !== 0">后台管理</router-link>
                        </el-dropdown-item>
                         <el-dropdown-item>
                            <router-link to="/factory" tag="p">返回首页</router-link>
                        </el-dropdown-item>
                    </el-dropdown-menu>
                </el-dropdown>
            </div>
