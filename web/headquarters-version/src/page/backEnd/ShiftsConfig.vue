<template>
    <div>
        <el-form :inline="true" :model="formInline" :rules="rules" ref="ruleForm" class="demo-form-inline" @submit.native.prevent v-if="isFormStatus">
            <el-form-item label="班组名称" prop="name">
                <el-select v-model="selectGroup" placeholder="请选择" @change="changeGroup">
        ...
        <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column align="center" min-width="150" label="搓作" v-if="isFormStatus">
