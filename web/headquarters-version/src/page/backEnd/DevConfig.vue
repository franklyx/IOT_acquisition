            ...
            <el-form-item label="设备图片">
                <el-radio-group v-model="form.pic_url">
                    <el-radio-button  v-for="item in radioList" :label="item.url" :key="item.id">
                        <div class="bgimg"  v-bind:style="{backgroundImage:'url(http://10.9.36.126:8000/'+item.url+')'}"></div>
                    </el-radio-button>
                </el-radio-group>
            </el-form-item>
            <el-form-item>
           ...
           <el-table :data="tableData" style="width: 100%">
               ...
               <el-table-column  align="center" min-width="150" label="图片" >
                   <template scope="scope">
                        <!-- <span>asdsad</span> -->
                        <div class="smallbg-img" v-bind:style="{backgroundImage:'url(http://10.9.36.126:8000/'+scope.row.mini_pic_url+')'}"></div>
                   </template>
               </el-table-column>
...
export default {
    ...
    computed: {
        ...mapGetters(['isFormStatus', 'getFactoryId'])
    },
    methods: {
