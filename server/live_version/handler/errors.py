...
status_36 = dict(status_code=400, reason='Factory_number already exists')
status_37 = dict(status_code=400, reason='Query does not exist for the field')
status_38 = dict(status_code=400, reason='The team did not bind flights')
